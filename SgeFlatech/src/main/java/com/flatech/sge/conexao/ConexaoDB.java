...
import java.sql.Connection; // representa conexao
import java.sql.DriverManager; // abre conexao
import java.sql.SQLException; // trata erros do banco
...
public class ConexaoDB {
    ...
    private static final String SENHA = "P@$$w0rd";  // <<<< ALTERE AQUI
